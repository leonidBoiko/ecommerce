...
class TestProductsModel(TestCase):
    def setUp(self):
        ...
        self.data1 = Product.objects.create(
            ...
            slug='django-beginners', regular_price='30.99', discount_price='20.00', image='django')
        # self.data2 = Product.products.create(
        #   category_id=1, title='django advanced', created_by_id=1,
        #   slug='django-advanced', regular_price='30.99', discount_price='20.00', image='django', is_active=False)
